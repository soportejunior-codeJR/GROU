...
export const LABELS: Record<string, string> = {
  ...
  prueba_completada: 'Completó prueba psicotécnica (Fase 2)',
  puntaje_prueba_pct: 'Puntaje prueba psicotécnica',
  pasa_fase2: 'Pasó Fase 2',
  fase3_asistio: 'Asistió a entrevista (Fase 3)',
  puntaje_pct: 'Puntaje entrevista (Fase 3)',
